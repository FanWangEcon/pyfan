...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{st_spec_key }\OperatorTok{=} \StringTok{'='}\NormalTok{.join(}\BuiltInTok{list}\NormalTok{(}\BuiltInTok{map}\NormalTok{(}\KeywordTok{lambda}\NormalTok{ x : }\StringTok{'$'} \OperatorTok{+} \BuiltInTok{str}\NormalTok{(x) }\OperatorTok{+} \StringTok{'$'}\NormalTok{, [}\StringTok{'ng_s_d'}\NormalTok{, }\StringTok{'esti_test_11_simu'}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{])))}
\BuiltInTok{print}\NormalTok{(st_spec_key.split(}\StringTok{'='}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{Data-Structures-and-Cloud-Services-with-Python_files/figure-latex/unnamed-chunk-51-1} \end{center}
...
\begin{center}\includegraphics{Data-Structures-and-Cloud-Services-with-Python_files/figure-latex/unnamed-chunk-53-1} \end{center}
...
\caption{\label{tab:unnamed-chunk-99}Chinese Long and Lat, Temperature Pressure, 2008 Jan 1st at 12 noon?}
\centering
...
\BuiltInTok{print}\NormalTok{(}\BuiltInTok{type}\NormalTok{(}\StringTok{'111'}\NormalTok{))}
...
\ExtensionTok{Examples}
\ExtensionTok{--------}
\OperatorTok{>>>} \ExtensionTok{log_vig_start}\NormalTok{(spt_root = proj_sys_sup.main_directory(),}
\ExtensionTok{...}\NormalTok{               main_folder_name=}\StringTok{'logvig'}\NormalTok{, sub_folder_name=}\StringTok{'parameters'}\NormalTok{,}
\ExtensionTok{...}\NormalTok{               subsub_folder_name=}\StringTok{'combo_type'}\NormalTok{,}
\ExtensionTok{...}\NormalTok{               file_name=}\StringTok{'fs_gen_combo_type'}\NormalTok{,}
\ExtensionTok{...}\NormalTok{               it_time_format=8, log_level=logging.INFO)}
\ExtensionTok{C}\NormalTok{:}\DataTypeTok{\textbackslash{}\textbackslash{}}\NormalTok{Users}\DataTypeTok{\textbackslash{}\textbackslash{}}\NormalTok{fan}\DataTypeTok{\textbackslash{}\textbackslash{}}\NormalTok{logvig}\DataTypeTok{\textbackslash{}\textbackslash{}}\NormalTok{parameters}\DataTypeTok{\textbackslash{}\textbackslash{}}\NormalTok{combo_type}\DataTypeTok{\textbackslash{}\textbackslash{}}\NormalTok{fs_gen_combo_type_20201030.log.py}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  \item
    \textbf{py}: \emph{zip() + upper() + fstring}
  \item
