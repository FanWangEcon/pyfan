# -*- coding: utf-8 -*-
#
# pyfan documentation build configuration file, created by
...
if not on_rtd:
    ...
    sys.path.insert(0, 'G:/repos/pyfan')
...
latex_documents = [
  ('index', 'pyfan.tex', u'pyfan Documentation',
   u'Fan Wang', 'manual'),
]
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(pyfan.__file__))
    ...
    if domain != 'py' or not info['module']:
        return None
    try:
        filename = 'pyfan/%s#L%d-L%d' % find_source()
    except Exception:
        filename = info['module'].replace('.', '/') + '.py'
    revision = _get_git_revision()
    return "https://github.com/fanwangecon/pyfan/blob/%s/%s" % (revision,
                                                                   filename)
